...
class _GeneratorScreenState extends State<GeneratorScreen> {
  ...
  Future<void> _downloadPdf() async {
    ...
    final uri = Uri.parse(pdfUrl!.startsWith('http') ? pdfUrl! : '$apiBaseUrl$pdfUrl');
    final response = await http.get(uri).timeout(const Duration(seconds: 30));
    if (response.statusCode != 200) {
      setState(() => statusMessage = 'Download failed: ${response.statusCode}');
      return;
    }
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton.icon(
                  onPressed: (!isLoading && pdfUrl != null) ? _downloadPdf : null,
